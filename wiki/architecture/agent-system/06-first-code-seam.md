...
Only after those exist should the first real runtime bridge and container host become executable.
...
If this sink does not exist first, the runtime bridge will inevitably improvise its own truth
surface.
...
### Not the runtime bridge alone

The runtime bridge is critical, but it should not be the first coded seam.
...
9. container host
10. runtime bridge implementation
