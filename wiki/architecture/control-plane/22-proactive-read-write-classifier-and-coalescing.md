...
- [../specs/60-proactive-read-admission-write-policy-contract.md](../specs/60-proactive-read-admission-write-policy-contract.md)
- [../specs/61-proactive-fallback-invocation-write-policy-contract.md](../specs/61-proactive-fallback-invocation-write-policy-contract.md)
- [../specs/62-proactive-read-write-classifier-contract.md](../specs/62-proactive-read-write-classifier-contract.md)
- [../specs/63-proactive-read-coalescing-and-duplicate-success-suppression-contract.md](../specs/63-proactive-read-coalescing-and-duplicate-success-suppression-contract.md)
- [23-proactive-read-write-coordinator-and-window-state.md](23-proactive-read-write-coordinator-and-window-state.md)
- [../specs/64-proactive-read-write-coordinator-contract.md](../specs/64-proactive-read-write-coordinator-contract.md)
