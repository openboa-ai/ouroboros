...
This section defines the subsystem that turns live runtime conditions into meaningful wakes above the
runtime.

## Why This Exists For MLP-01

MLP-01 does not count if a bounded live `TraderSystemRuntime` still requires constant shadow
monitoring.
...
- semantic attention construction for runtime activation
- meaningful operator wake generation
- urgency semantics for live conditions
- the boundary between substrate facts, runtime attention, and operator-visible wake reasons
...
| --- | --- |
| PRD 3 | bounded live runtime execution stays responsive without reducing the product to manual polling |
...
Recovery must assume missed, bursty, noisy, or stale context.

The answer is semantic attention plus explicit authority boundaries, not runtime-owned timers,
closed event enums, or constant operator watching.

## Current Active Docs

- [01-overview.md](01-overview.md)
- [02-semantic-attention-and-wake.md](02-semantic-attention-and-wake.md)
...
Read [../04-pr4-live-runtime-remains-controllable-design.md](../04-pr4-live-runtime-remains-controllable-design.md)
...
Older trigger-taxonomy and scheduler-centric pages are preserved under
[../historical/proactive-operations/](../historical/proactive-operations/).
