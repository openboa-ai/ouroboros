...
> one container-backed workspace host, one runtime connector, and one external trace sink.
...
### 8. Runtime connector implementation
...
- letting the runtime connector become the first owner of durable truth
...
- [../historical/specs/16-production-agent-state-machine.md](../historical/specs/16-production-agent-state-machine.md)
- [../historical/specs/17-production-agent-tool-surface-and-guardrails.md](../historical/specs/17-production-agent-tool-surface-and-guardrails.md)
- [../historical/specs/18-production-agent-observability-and-slos.md](../historical/specs/18-production-agent-observability-and-slos.md)
