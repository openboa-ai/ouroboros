# Success Metrics And Launch Bar

## Purpose

This page defines how MLP-01 is judged.
...
### Primary: Trustworthy Delegation

One `TraderSystemCandidate` reaches bounded live operation while the operator no longer acts as the
permanent runtime.
...
- live agent authority is bounded through gateway
- wake/intervention is strong enough for delegation to feel recoverable
- the operator can explain the trust chain without private notes
...
The operator prefers this over stitched manual scripts, chats, notebooks, dashboards, and exchange
monitoring for the chosen wedge.
...
- candidate system identity is understood quickly
- capability packages clarify rather than confuse
- external evidence explains progression
- live gate feels serious
- order intent/gateway distinction is understood
- wake reasons feel meaningful
...
The clearest fake success is hidden human labor.
...
Kill or reframe MLP-01 if:

- the chosen operator does not value trustworthy delegation enough
- a trader-system candidate pool is less useful than manual strategy authoring for this wedge
- external evidence cannot become credible without much broader scope
- bounded live authority still feels unsafe even when technically correct
- the product keeps collapsing into idea generation plus manual glue

## Judgment Rule

Do not claim MLP-01 worked unless all three are true:

- the system functions
- the operator prefers it
- the operator trusts bounded delegation
