...
Use `pr-ci-review-loop` when the current owner must keep checking current-head CI, CodeQL, review
comments, bounded fixes, repeat pushes, and final merge once validation is clean.
