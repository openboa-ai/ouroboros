...
- [x] **Step 1: Write failing empty and progress tests**
...
- [x] **Step 3: Add exact domain read-model interfaces**
...
- [x] **Step 4: Implement deterministic empty and active projection**
...
- [x] **Step 5: Add failing closed/latest and simultaneous active/latest tests**
...
- [x] **Step 6: Add failing corruption, ordering, and immutability tests**
...
- [x] **Step 7: Complete strict projection and export it**

Implement the latest-outcome projection, strict graph checks, clone boundaries, and export from
`packages/application/src/index.ts`.

- [x] **Step 8: Run focused tests and package typechecks**
...
- Produces: required `CandidateArenaReadModel.research_generalization` for `GET /api/operator` and
  `arena.status`.

- [x] **Step 1: Write failing operator readback tests**
...
- [x] **Step 3: Load and project exact graph arrays in CandidateArena**
...
- [x] **Step 4: Update typed fixtures with canonical empty projection**
...
- [x] **Step 5: Run application/runtime tests and typechecks**
...
- [x] **Step 1: Write failing CLI and TUI parity tests**
...
- [x] **Step 2: Implement one compact formatter per surface**
...
- [x] **Step 3: Run CLI/TUI tests and typechecks**
...
- [x] **Step 4: Write failing Web Research section tests**
...
- [x] **Step 5: Add the focused Web section**
...
- [x] **Step 6: Wire the section before FindingCluster**
...
- [x] **Step 7: Run Web tests and typecheck**
...
- [x] **Step 8: Run interface parity tests**
...
- [x] **Step 1: Record the shared read-model contract**
...
- [x] **Step 3: Run all workspace typechecks and full tests**
...
- [x] **Step 4: Run required repository guards**
...
- [x] **Step 5: Review scope and authority**
