...
try:
    ...
    if a.rendered_environment:
        from tests.support.fixture_service_units import start as start_services, verify as verify_services
    ...
    if a.native_adapter:
        from tests.support.native_adapter_fixture import NativeAdapterFixture
    ...
    if a.runtime_unit_loss:
        from tests.support.fixture_runtime_unit_loss import start as start_unit
    ...
    if a.runtime_unit_loss:
        from tests.support.fixture_runtime_unit_loss import verify as verify_unit_loss
    ...
    if runtime_unit is not None:
        from tests.support.fixture_runtime_unit_loss import close_rendered
        close_rendered(root,runtime_unit)
    if rendered_environment_state is not None:
        from tests.support.fixture_service_units import close as close_services
