...
from tests.support.native_image_identity import SOURCE_LABEL, CLI_LABEL, MATERIALIZER_LABEL, PROBE_LABEL, source_digest
...
def load_environment(filename):
    ...
    if not (data['source_root'] / 'tests/integration/test-connected-native-guest.py').is_file():
