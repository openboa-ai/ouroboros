...
_IMAGE_SCRIPTS = (
    'tests/support/prepare-codex-fixture.sh', 'tests/support/prepare-connected-native.sh',
    'tests/support/prepare-connected-program.sh', 'tests/support/test-profile.sh',
    'tests/support/native_image_identity.py', 'tests/support/prepare-checkpoint-read-fixture.py',
)
...
def source_digest(root):
    ...
    for pattern in ('crates/**/*.rs', 'crates/**/*.sql', 'crates/**/Cargo.toml', 'tests/fixtures/*.rs'):
