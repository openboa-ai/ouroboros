...
export const OPERATOR_DESIGN_TOKENS = {
  ...
  surface: {
    ...
    selectionItem: `grid h-auto min-w-0 max-w-full justify-start ${OPERATOR_SIZE_TOKENS.compactContentGap} ${OPERATOR_RADIUS_TOKENS.panel} px-3 py-3 text-left text-sm ring-1 transition`,
