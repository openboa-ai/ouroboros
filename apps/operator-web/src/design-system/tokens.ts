...
export const OPERATOR_DESIGN_TOKENS = {
  ...
  layout: {
    ...
    sidebarFrame: "min-w-0",
    sidebarMenuButton: "min-w-0 max-w-full",
    sidebarMenuBadge: `${OPERATOR_RADIUS_TOKENS.badge} tabular-nums`,
    sidebarMenuSkeleton: "min-w-0 max-w-full",
    sidebarGroupLabel: "tracking-normal",
