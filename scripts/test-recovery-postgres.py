...
def main():
    ...
    children = []
    from fixture_recovery_inspection import free_port
    ...
    with tempfile.TemporaryDirectory(prefix='pg-', dir=parent) as temporary:
        ...
        try:
            ...
            from fixture_recovery_schema import prepare, snapshot
            databases = prepare(sql, args.source_root.resolve(strict=True))
            inspection_context = None
            if args.inspection:
                from fixture_recovery_inspection import prepare as prepare_inspection
            ...
            if inspection_context:
                from fixture_recovery_inspection import inspect
