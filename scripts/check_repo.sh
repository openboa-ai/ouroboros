...
required_files=(
  ...
  "src-tauri/src/application/queries.rs"
  "src-tauri/src/application/mutations.rs"
  "src-tauri/src/lib.rs"
  "src-tauri/src/commands/mod.rs"
  "src-tauri/src/commands/queries.rs"
  "src-tauri/src/commands/mutations.rs"
  "src-tauri/src/models.rs"
  "src-tauri/src/state.rs"
  "src-tauri/src/workspace/policies.rs"
  "src-tauri/src/workspace/policies/exports.rs"
  "src-tauri/src/workspace/policies/imports.rs"
  "src-tauri/src/workspace/policies/live.rs"
